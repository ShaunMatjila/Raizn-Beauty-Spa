...
export default function WhatsAppWidget() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 bg-green-500 hover:bg-green-600 rounded-full p-4 shadow-lg transition-colors duration-200 group"
    ...
    >
      <svg
        ...
        className="text-white fill-white w-6 h-6 group-hover:scale-110 transition-transform duration-200"
      >
