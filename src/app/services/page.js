      ...
      <div className="relative min-h-[70vh]">
        ...
        <div className="relative z-10 flex items-end min-h-[80vh] container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-24 pb-8 sm:pt-28 sm:pb-12 md:pt-32 md:pb-16">
          <div className="w-full">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white leading-tight mb-4 sm:mb-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20">
            {serviceCategories.map((category) => (
              <div key={category.id} className="space-y-8">
                <div className="border border-gray-200 rounded-lg p-6 hover:border-primary/30 transition-colors duration-200">
          ...
          <div className="bg-primary rounded-2xl p-8 text-white">
            ...
            <p className="text-white/90 mb-6 max-w-2xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                {/* <Link 
                href="/"
                className="inline-block bg-white text-primary px-8 py-3 rounded-xl font-semibold hover:bg-primary/5 transition-colors duration-200"
              >
                Book Online Now
              </Link> */}
              <a
                ...
                className="bg-green-500 text-white px-8 py-3 rounded-lg font-semibold transition-colors duration-200 flex items-center gap-2"
              >
